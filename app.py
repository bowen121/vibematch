...
<div style="position:relative;z-index:2;display:flex;align-items:center;
  justify-content:space-between;padding:5px 60px 8px;color:var(--ink-2);
...
if st.session_state.results or st.session_state.loading:
    ...
    if query_genre_scores and not st.session_state.loading:
        pills = "".join(
            ...
            f'border-radius:20px;padding:3px 6px;font-family:var(--mono);font-size:10.5px;'
        ...
        genre_pills_html = (
            f'<div style="display:flex;align-items:center;gap:8px;flex-wrap:nowrap;margin-left:14px;">'
            f'<span style="color:var(--ink-2);font-family:var(--mono);'
            f'letter-spacing:.01em;text-transform:uppercase;white-space:nowrap;flex-shrink:0;">'
